...
//        try {
//            sendTextMsg("我就是我, 是不一样的烟火", new ArrayList<String>(), new LinkedList<String>(), false);
//        } catch (Exception e) {
...
//                    true, new ArrayList<String>(), new ArrayList<String>());
//        } catch (Exception e) {
//            logger.error("钉钉群消息发送异常，异常原因：{}", e.toString());
//        }
//    }
...
//
//        HashMap<String, java.io.Serializable> reqMap = new HashMap<String, java.io.Serializable>();
